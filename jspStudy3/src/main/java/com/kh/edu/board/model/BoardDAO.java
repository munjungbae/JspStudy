...
public class BoardDAO {
	...
	private final String SELECT_PASS_SQL = "select count(*) count from board2 where num = ? and pass = ?";

	private final String INSERT_SQL = "insert into board2(num, writer, subject, pass, regdate, ref, step, depth, content) "
	...
	public BoardVO selectBoardDB(BoardVO bvo) {
		...
		try {
			...
			if (rs.next()) {
				...
				vo = new BoardVO(num, writer, subject, pass, readcount, ref, step, depth, regdate, content);
