...
<form method="post" action="basketinsert.jsp" name="ticketForm">
	<input type="hidden" name="price" value=19000> <img
		src="./image/capybara.jpg" alt="" class="capy_detail">
	<p class="title">먹이주기 체험</p>
	<p class="price">19000원</p>
	...
	<select name="ticket_list" id="ticket_list">
		<option disabled hidden selected class="option_value">메뉴를 선택
			해 주세요</option>
		<option value="먹이주기 체험">먹이주기 체험 1인 입장권 19000원</option>
	</select>
	<p id="result"></p>
...
<%
String ticketName = "먹이주기 체험 1인 입장권 19000원";
%>
<script>
