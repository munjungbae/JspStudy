...
<form method="post" action="basketinsert.jsp" name="ticketForm">
	<input type="hidden" name="price" value=15000> <img
		src="./image/otter.jpg" alt="" class="cat_detail">
	<p class="title">동물원 두드림 교육</p>
	...
	<select name="ticket_list" id="ticket_list">
		<option disabled hidden selected class="option_value">메뉴를 선택
			해 주세요</option>
		<option value="동물원 두드림 교육">동물원 두드림 교육 1인 입장권 15000원</option>
	</select>
	<p id="result"></p>
...
<%
String ticketName = "동물원 두드림 교육 1인 입장권 15000원";
%>
<script>
