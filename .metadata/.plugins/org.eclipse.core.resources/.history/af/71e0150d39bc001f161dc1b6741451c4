...
<link href="style.css?timestamp=<%=System.currentTimeMillis()%>" rel="stylesheet" type="text/css" />
...
<body bgcolor="<%=bodyback_c%>">
	...
	<form method="post" name="writeForm" action="writeProc.jsp"
		...
		<table width="400" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td width="90" bgcolor="<%=value_c%>" align="center">이름</td>
				<td width="330"><input type="text" size="12" maxlength="12"
					name="writer" /></td>
			</tr>
			<tr>
				<td width="90" bgcolor="<%=value_c%>" align="center">이메일</td>
				<td width="330"><input type="text" size="30" maxlength="30"
					name="email" /></td>
			</tr>
			<tr>
				<td width="90" bgcolor="<%=value_c%>" align="center">제목</td>
				<td width="330">
					<%
					if (request.getParameter("num") == null) {
					%>
			...
			<tr>
				<td width="90" bgcolor="<%=value_c%>" align="center">내용</td>
				<td width="330"><textarea name="content" rows="13" cols="50"></textarea>
				</td>
			</tr>
			<tr>
				<td width="90" bgcolor="<%=value_c%>" align="center">비밀번호</td>
